...
public class CameraHandler implements View.OnClickListener {
    ...
    public CameraHandler(BaseDelegate delegate) {
    ...
    public void showDialog() {
        ...
        if (window != null) {
            ...
            DIALOG.findViewById(R.id.photodialog_btn_take).setOnClickListener(this);
            DIALOG.findViewById(R.id.photodialog_btn_native).setOnClickListener(this);
            DIALOG.findViewById(R.id.photodialog_btn_cancel).setOnClickListener(this);
        }
    }
